...
# Helper functions
# 👈 TODO: Add the caching decorator at step 3
...
with st.sidebar:
    ...
    # TODO: add more widgets for FOOOF parameters
...
# TODO: add values from new widgets as well
# TODO: comment the line below once everything is working
st.write(f'Channel: {channel}, annotate_peaks: {annotate_peaks}, annotate_aperiodic: {annotate_aperiodic}')
...
# TODO: use the values of FOOOF parameters
fm = FOOOF()
fm.fit(freqs, np.squeeze(psd))
